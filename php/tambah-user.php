...
if (isset($_POST['edit'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE user SET nama='$nama', jenis_kelamin='$jenis_kelamin', telepon='$telepon' WHERE id='$id' ");
...
<body>
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            ...
            <input <?php echo isset($_GET['edit']) ? ($rowEdit['jenis_kelamin'] == "Laki-laki") ? 'checked' : '' : '' ?> type="radio" name="jenis_kelamin" value="Laki-laki">Laki-laki <br>
