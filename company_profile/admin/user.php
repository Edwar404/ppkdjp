...
// mysqli_fetch_assoc = untuk menjadikan query menjadi sebuah menjadi data(object,array)?

// Jika parameternya ada (?delete=nilai dari parameter)
if (isset($_GET['delete'])) {
    $id = $_GET['delete']; //Mengambil nilai parameter(dalam kasus ini adalah nomor id)
    // query untuk delete
                                                ...
                                                while ($rowUser = mysqli_fetch_assoc($queryUser)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?')" href="user.php?delete=<?php echo $rowUser['id'] ?>" class="btn btn-danger btn-sm">
